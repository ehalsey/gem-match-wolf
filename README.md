...
9. **Create power-ups in the center** - They're easier to activate when surrounded by gems

### Scoring Tips
10. **Watch the floating scores** - Gold text appears showing exactly how many points each match earned
11. **Cascades multiply your score** - Each cascade level increases your points exponentially
12. **Longer chains = more points** - A 6-match is worth much more than two 3-matches
13. **Power-up activations are huge** - They clear many gems and can trigger cascades

### Move Management
14. **Don't rush** - Think before each move; you only get 30 moves
15. **Watch the move counter** - Changes color at 10 moves (orange) and 5 moves (red)
16. **Forced moves** - If you see "No more moves!" you weren't looking carefully enough

### Advanced Tactics
17. **Corner strategy** - Work from corners and edges to create cascades toward the center
18. **L-shapes and 2x2 squares** - Special patterns create the most powerful boosters (TNT, Fly-Away)
19. **Setup moves** - Sometimes make a "bad" move to set up a better one next turn
20. **Fly-Away targets** - The Fly-Away automatically finds the best strategic target with most matching neighbors
